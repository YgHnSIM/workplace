...
const archiveCategories = Object.freeze([
  ...
  Object.freeze({ key: 'statement', label: '성명서', directory: 'statement' }),
  Object.freeze({ key: 'mom', label: '회의록', directory: 'MoM' }),
  Object.freeze({ key: 'knowledge', label: '지식', directory: 'knowledge' }),
  Object.freeze({ key: 'notice', label: '알림', directory: 'notice' }),
]);
